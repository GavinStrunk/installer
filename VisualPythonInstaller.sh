...
#=====================================================================   
#Install vpython in the directory you run this script from
INSTALL_PATH=$PWD
...
sudo python2.7 build-wxpython.py --install --prefix=/home/$SUDO_USER/.virtualenvs/workspace/lib/ --reswig
deactivate
cd $INSTALL_PATH
